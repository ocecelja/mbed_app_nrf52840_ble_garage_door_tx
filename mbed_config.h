...
#define MBED_CONF_DRIVERS_UART_SERIAL_RXBUF_SIZE                              64                                                                                               // set by application[*]
#define MBED_CONF_DRIVERS_UART_SERIAL_TXBUF_SIZE                              1024                                                                                             // set by application[*]
...
#define MBED_CONF_EVENTS_USE_LOWPOWER_TIMER_TICKER                            1                                                                                                // set by application[*]
...
#define MBED_CONF_RTOS_IDLE_THREAD_STACK_SIZE                                 1024                                                                                             // set by application[*]
...
#define MBED_CONF_TARGET_CONSOLE_UART                                         1                                                                                                // set by application[*]
